...
404.html                  ← Redirects to pages/404.html ⚠️
...
2. Open `index.html` in your browser. 🖥️
3. Edit files in `pages/`, `css/`, `js/` to personalize. ✏️
4. Replace images in `images/`. 🖼️
